...
public /*@ nullable_by_default */ class MyGroup_JML_Test {
   ...
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_MyGroup__int_id1__0")
  public void test_MyGroup__int_id1__0
  (final int id1) {
    try {
      new MyGroup(id1);
    }
      ...
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_MyGroup__int_id1__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
   ...
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_addRelation__int_id1__int_id2__0")
  public void test_addRelation__int_id1__int_id2__0
  (final MyGroup the_test_object, 
   final int id1, final int id2) {
    ...
    try {
      the_test_object.addRelation(id1, id2);
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_addRelation__int_id1__int_id2__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
  ...
  /**
   * A test for method getPeopleSize.
   *
   * @param the_test_object The MyGroup to call the test method on.
   */
  @Test(dependsOnMethods = { "test_racEnabled" }, 
        dataProvider = "p_instance_only")
  public void test_getPeopleSize__0
  (final MyGroup the_test_object ) {
      if (the_test_object == null) {
        throw new PreconditionSkipException
        ("could not construct an object to test");
    ...
    try {
      the_test_object.getPeopleSize();
    }
    catch (final JmlAssertionError $e) {
      if ($e.jmlAssertionType.equals("Precondition") &&
          $e.getStackTrace().length >= 4 &&
          "test_getPeopleSize__0".equals($e.getStackTrace()[3].getMethodName())) {
        // meaningless test because precondition failed
        throw new PreconditionSkipException($e.getMessage());
      } else {
        // test failure because something else failed
   ...
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_MyGroup__int_id1__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_MyGroup__int_id1__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (MyGroup_MyGroup__int_id1__0__id1.class));
  }



  /**
   * Data provider for method void addRelation(int, int).
   * @return An iterator over strategies to use for parameter generation.
   */
  @SuppressWarnings({"unchecked"})
  @DataProvider(name = "p_addRelation__int_id1__int_id2__0", 
                parallel = false)
  public static IteratorWrapper<Object[]> p_addRelation__int_id1__int_id2__0() {
    return new IteratorWrapper<Object[]>
    (new ParameterArrayIterator
         (MyGroup_InstanceStrategy.class,
          MyGroup_addRelation__int_id1__int_id2__0__id1.class,
                  MyGroup_addRelation__int_id1__int_id2__0__id2.class));
  }
