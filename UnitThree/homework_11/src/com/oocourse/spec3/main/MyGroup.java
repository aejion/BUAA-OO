...
public class MyGroup implements Group {
    private int id;
    private HashMap<Person,Integer> people = new HashMap<Person,Integer>();
    private HashMap<Integer,Person> people1 = new HashMap<Integer,Person>();
