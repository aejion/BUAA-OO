...
public class UmlRegion extends UmlElement {
    ...
    private UmlRegion(AbstractElementData elementData, Visibility visibility) {
        super(elementData);
        this.visibility = visibility;
    }

    public static UmlRegion loadFromJson(Object jsonObject) throws UmlParseException {
        ...
        return new UmlRegion(elementData, visibility);
    }

    public static UmlRegion loadFromExportedJson(Object jsonObject) throws UmlParseException {
        AbstractElementData elementData = loadAbstractDataFromJson(jsonObject);
        if (!(jsonObject instanceof Map)) {
            throw new UmlParseNotObjectException(jsonObject);
        }
    ...
    public boolean equals(Object o) {
        ...
        UmlRegion umlRegion = (UmlRegion) o;
        return visibility == umlRegion.visibility;
    }
