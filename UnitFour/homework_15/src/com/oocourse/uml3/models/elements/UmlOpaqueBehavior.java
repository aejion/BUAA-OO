...
public class UmlOpaqueBehavior extends UmlElement {
    ...
    private UmlOpaqueBehavior(AbstractElementData elementData, Visibility visibility) {
        super(elementData);
        this.visibility = visibility;
    }

    public static UmlOpaqueBehavior loadFromJson(Object jsonObject) throws UmlParseException {
        ...
        return new UmlOpaqueBehavior(elementData, visibility);
    }

    public static UmlOpaqueBehavior loadFromExportedJson(Object jsonObject) throws UmlParseException {
        AbstractElementData elementData = loadAbstractDataFromJson(jsonObject);
        if (!(jsonObject instanceof Map)) {
            throw new UmlParseNotObjectException(jsonObject);
        }
    ...
    public ElementType getElementType() {
        return ElementType.UML_OPAQUE_BEHAVIOR;
    }
    ...
    public boolean equals(Object o) {
        ...
        UmlOpaqueBehavior that = (UmlOpaqueBehavior) o;
