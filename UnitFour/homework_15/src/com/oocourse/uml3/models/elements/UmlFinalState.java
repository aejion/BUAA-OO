...
public class UmlFinalState extends UmlElement {
    private static final String VISIBILITY_KEY = "visibility";
    private final Visibility visibility;

    private UmlFinalState(AbstractElementData elementData, Visibility visibility) {
        super(elementData);
        this.visibility = visibility;
    }

    public static UmlFinalState loadFromJson(Object jsonObject) throws UmlParseException {
        ...
        return new UmlFinalState(elementData, visibility);
    }

    public static UmlFinalState loadFromExportedJson(Object jsonObject) throws UmlParseException {
        AbstractElementData elementData = loadAbstractDataFromJson(jsonObject);
        if (!(jsonObject instanceof Map)) {
            throw new UmlParseNotObjectException(jsonObject);
        }
    ...
    public ElementType getElementType() {
        return ElementType.UML_FINAL_STATE;
    }
    ...
    public boolean equals(Object o) {
        ...
        UmlFinalState that = (UmlFinalState) o;
