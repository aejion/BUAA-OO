...
public class UmlInteraction extends UmlElement {
    ...
    private UmlInteraction(AbstractElementData elementData, Visibility visibility) {
        super(elementData);
        this.visibility = visibility;
    }

    public static UmlInteraction loadFromJson(Object jsonObject) throws UmlParseException {
        ...
        return new UmlInteraction(elementData, visibility);
    }

    public static UmlInteraction loadFromExportedJson(Object jsonObject) throws UmlParseException {
        AbstractElementData elementData = loadAbstractDataFromJson(jsonObject);
        if (!(jsonObject instanceof Map)) {
            throw new UmlParseNotObjectException(jsonObject);
        }
    ...
    public boolean equals(Object o) {
        ...
        UmlInteraction that = (UmlInteraction) o;
